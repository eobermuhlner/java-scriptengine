...
public class JavaScriptEngineFactoryTest {
    ...
    public void testGetEngineVersion() {
        JavaScriptEngineFactory factory = new JavaScriptEngineFactory();
        assertThat(factory.getEngineVersion()).isEqualTo("1.0.1");
    }
    ...
    public void testGetNames() {
        JavaScriptEngineFactory factory = new JavaScriptEngineFactory();
        assertThat(factory.getNames()).isEqualTo(Arrays.asList("Java", "java", "ch.obermuhlner:java-scriptengine", "obermuhlner-java"));
    }
